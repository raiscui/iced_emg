...
use crate::{
    ...
    g_node::{EmgNodeItem, GraphType, NDate},
    GTreeBuilderElement, GTreeBuilderFn,
};
use crate::{GElement, NodeIndex};
use emg::{edge_index_no_source, node_index, Edge, EdgeIndex, NodeEdgeCollect, Node};
...
Ix: std::clone::Clone + std::hash::Hash + std::cmp::Ord + std::default::Default + 'static, {
    ...
    incoming_eix_set:Option<NodeEdgeCollect<Ix>>,
    outgoing_eix_set:Option<NodeEdgeCollect<Ix>>,
...
Message: std::cmp::PartialEq + std::clone::Clone + 'static, 
{
    ...
    #[allow(clippy::missing_const_for_fn)]
    fn set_incoming_eix_set(mut self, incoming_eix_set: NodeEdgeCollect<IdStr>)->Self {
        self.incoming_eix_set = Some(incoming_eix_set);
        self
    }

    #[allow(clippy::missing_const_for_fn)]
    fn set_outgoing_eix_set(mut self, outgoing_eix_set: NodeEdgeCollect<IdStr>)->Self {
