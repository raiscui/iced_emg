...
impl<Ix, Message> RefreshFor<EmgEdgeItem<Ix>> for AnimationEOG<Message>
where
        ...
        + std::fmt::Display,
{
    fn refresh_for(&self, edge: &mut EmgEdgeItem<Ix>) {
        ...
        trace!(
            "AnimationEOG  RefreshFor EmgEdgeItem snapshot: \n{:#?}",
