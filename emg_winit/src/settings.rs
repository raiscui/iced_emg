 ...
 * @LastEditTime: 2022-08-24 01:28:27
 * @LastEditors: Rais
 * @Description:
 */
...
use crate::{Mode, SemanticPosition};
...
impl Window {
    ...
    pub fn into_builder(
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            window_builder =
                window_builder.with_drag_and_drop(self.platform_specific.drag_and_drop);
        }
        ...
        #[cfg(target_os = "macos")]
        {
            ...
            window_builder = window_builder
                ...
                .with_titlebar_transparent(self.platform_specific.titlebar_transparent)
                .with_fullsize_content_view(self.platform_specific.fullsize_content_view);
        }

        window_builder =
            window_builder.with_fullscreen(conversion::fullscreen(primary_monitor, mode));

        window_builder
    }
}
//NOTE no def , use root settings::into()
